...
[#features_user_name_validation]
=== User name validation
This service has a custom validator that checks when a new user is being created if
the user name is complying with the following set of rules:
