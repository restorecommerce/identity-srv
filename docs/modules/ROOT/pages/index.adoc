...
* Configurable in-built https://github.com/restorecommerce/access-control-srv[access-control] mechanism
...
`io.restorecommerce.user.HierarchicalScopesRequest`
...
`io.restorecommerce.user.HierarchicalScopesResponse`
