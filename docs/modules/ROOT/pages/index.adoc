...
|authorization |`io.restorecommerce.auth.Subject` or `io.restorecommerce.auth.ApiKey` |optional |authorization details
|==========================================================================================================================
...
|last_login | double |optional | epoch time of user last logged in
...
|Field |Type |Label |Description
|name |string |required |Token name
|expires_at |number |optional |expiration date for token
|token |string |required |token value
...
The microservice exposes the below operations for creating or modifying Token resources.
...
|=========================================================================================================================
|Method Name |Request Type |Response Type |Description
|Upsert |`io.restorecommerce.user.RoleList` |`io.restorecommerce.user.RoleList` |Create a list of Role resources
|Find |`io.restorecommerce.resourcebase.ReadRequest` |`io.restorecommerce.user.RoleList` |Read a list of Role resources
|FindByUid |`io.restorecommerce.user.RoleList` |`io.restorecommerce.user.RoleList` |Update a list of Role resources
|FindByUserCode |`io.restorecommerce.resourcebase.DeleteRequest` |Empty |Delete a list of Role resources
|Destroy |`io.restorecommerce.user.RoleList` |`io.restorecommerce.user.RoleList` |Create or Update a list of Role resources
|RevokeByGrantId |`io.restorecommerce.user.RoleList` |`io.restorecommerce.user.RoleList` |Create or Update a list of Role resources
|Consume |`io.restorecommerce.user.RoleList` |`io.restorecommerce.user.RoleList` |Create or Update a list of Role resources
|=========================================================================================================================
